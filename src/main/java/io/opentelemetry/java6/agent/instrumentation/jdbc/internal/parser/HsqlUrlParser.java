...
import static io.opentelemetry.java6.agent.instrumentation.jdbc.internal.parser.UrlParsingUtils.indexOfAny;
...
public final class HsqlUrlParser implements JdbcUrlParser {
  ...
  private static Map<String, Integer> buildNetworkModes() {
    Map<String, Integer> modes = new HashMap<String, Integer>(4);
