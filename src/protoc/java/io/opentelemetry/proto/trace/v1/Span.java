...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && (getEndTimeUnixNano()
        == other.getEndTimeUnixNano());
    result = result && getAttributesList()
        .equals(other.getAttributesList());
    result = result && (getDroppedAttributesCount()
        == other.getDroppedAttributesCount());
    ...
    result = result && (getDroppedEventsCount()
        == other.getDroppedEventsCount());
  ...
  checkByteStringIsUtf8(value);
    ...
    private io.opentelemetry.proto.trace.v1.Status status_ = null;
