...
import static io.opentelemetry.java6.agent.instrumentation.jdbc.internal.JdbcConnectionUrlParser.parse;
...
class JdbcConnectionUrlParserTest {
  ...
  // semconv DbSystemIncubatingValues used by the main project's test
  ...
  private static List<Arguments> mySqlArguments() {
    return args(
  ...
  private static List<Arguments> clickHouseArguments() {
    return args(
  ...
  private static List<Arguments> postgresArguments() {
    return args(
  ...
  private static List<Arguments> mariaDbArguments() {
    return args(
  ...
  private static List<Arguments> sqlServerArguments() {
    return args(
  ...
  private static List<Arguments> oracleArguments() {
    return args(
  ...
  private static List<Arguments> db2Arguments() {
    return args(
  ...
  private static List<Arguments> sapArguments() {
    return args(
  ...
  private static List<Arguments> informixArguments() {
    return args(
  ...
  private static List<Arguments> h2Arguments() {
    return args(
  ...
  private static List<Arguments> hsqlDbArguments() {
    return args(
  ...
  private static List<Arguments> derbyArguments() {
    return args(
  ...
  private static List<Arguments> dataDirectArguments() {
    return args(
  ...
  private static List<Arguments> tibcoArguments() {
    return args(
  ...
  private static List<Arguments> secretsManagerArguments() {
    return args(
  ...
  private static List<Arguments> openTracingArguments() {
    return args(
  ...
  private static List<Arguments> oceanbaseArguments() {
    return args(
  ...
  private static List<Arguments> lindormArguments() {
    return args(
  ...
  private static List<Arguments> polardbArguments() {
    return args(
  ...
  private static List<Arguments> amazonAuroraArguments() {
    return args(
  ...
  private static List<Arguments> sqliteArguments() {
    return args(
  ...
  static List<Arguments> args(ParseTestArgument... testArguments) {
