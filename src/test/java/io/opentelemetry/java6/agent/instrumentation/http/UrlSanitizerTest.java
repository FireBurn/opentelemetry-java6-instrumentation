...
class UrlSanitizerTest {
  ...
  void shouldRedactUserInfoAndQueryParameters(String url, String expectedResult) {
    assertThat(UrlSanitizer.sanitizeUrl(url, SENSITIVE_QUERY_PARAMETERS))
  ...
  void shouldRedactUserInfoWhenNoSensitiveQueryParametersConfigured() {
    ...
    assertThat(UrlSanitizer.sanitizeUrl(URL_WITH_USER_INFO, java.util.Collections.<String>emptySet()))
